<?php
// source: /home/marw/PhpstormProjects/ValTournamentss/config/common.neon
// source: /home/marw/PhpstormProjects/ValTournamentss/config/services.neon
// source: array
...
class Container_e5aa117f5f extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Model\TournamentManager' => [['03']],
		'App\Model\TeamManager' => [['04']],
		'App\Model\ForumManager' => [['05']],
		'Nette\Routing\RouteList' => [['06']],
		'Nette\Routing\Router' => [['06']],
		'ArrayAccess' => [
			2 => [
				'06',
				'application.1',
		...
		'Nette\Application\Routers\RouteList' => [['06']],
		...
		'App\Presentation\Tournament\TournamentPresenter' => [2 => ['application.4']],
		'App\Presentation\Admin\AdminPresenter' => [2 => ['application.5']],
		'App\Presentation\Team\TeamPresenter' => [2 => ['application.6']],
		'App\Presentation\Home\HomePresenter' => [2 => ['application.7']],
		'App\Presentation\Home\TournamentsPresenter' => [2 => ['application.8']],
		'App\Presentation\Forum\ForumPresenter' => [2 => ['application.9']],
		'App\Presentation\Teams\TeamsPresenter' => [2 => ['application.10']],
	...
	{
		return new App\Model\MyAuthenticator($this->getService('database.default.explorer'), $this->getService('security.passwords'));
	}


	public function createService03(): App\Model\TournamentManager
	{
		return new App\Model\TournamentManager($this->getService('database.default.explorer'));
	}


	public function createService04(): App\Model\TeamManager
	{
		return new App\Model\TeamManager($this->getService('database.default.explorer'));
	}


	public function createService05(): App\Model\ForumManager
	{
		return new App\Model\ForumManager($this->getService('database.default.explorer'));
	}


	public function createService06(): Nette\Application\Routers\RouteList
	{
	...
	{
		$service = new App\Presentation\Sign\SignPresenter($this->getService('security.user'), $this->getService('01'));
	...
	public function createServiceApplication__10(): App\Presentation\Teams\TeamsPresenter
	{
		$service = new App\Presentation\Teams\TeamsPresenter($this->getService('04'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	{
		return new NetteModule\MicroPresenter($this, $this->getService('http.request'), $this->getService('06'));
	}
	...
	public function createServiceApplication__4(): App\Presentation\Tournament\TournamentPresenter
	{
		$service = new App\Presentation\Tournament\TournamentPresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\Presentation\Admin\AdminPresenter
	{
	...
	public function createServiceApplication__6(): App\Presentation\Team\TeamPresenter
	{
		$service = new App\Presentation\Team\TeamPresenter($this->getService('04'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	{
		$service = new App\Presentation\Home\HomePresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__8(): App\Presentation\Home\TournamentsPresenter
	{
		$service = new App\Presentation\Home\TournamentsPresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__9(): App\Presentation\Forum\ForumPresenter
	{
		$service = new App\Presentation\Forum\ForumPresenter($this->getService('05'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/marw/PhpstormProjects/ValTournamentss/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/home/marw/PhpstormProjects/ValTournamentss/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/home/marw/PhpstormProjects/ValTournamentss/temp/cache',
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=val_tournaments',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/'root'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_e5aa117f5f $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/marw/PhpstormProjects/ValTournamentss/temp/cache/latte');
